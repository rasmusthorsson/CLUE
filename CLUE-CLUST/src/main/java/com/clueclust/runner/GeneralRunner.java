...
//Runner for the main ConcurrentLSHDBSCAN algorithm
public class GeneralRunner implements Runner {
    private static final int NUMBER_OF_BATCHES = 100;
    ...
    public void run(Parameters params) {
        try {
            ...
            // dataset.validateOriginalFeatures();
            ...
            ConcurrentLSHDBSCAN lshdbscan = new ConcurrentLSHDBSCAN(
                    dataset,
            ...
            System.out.println("Performing concurrent clustering...");
            
            startTime = System.nanoTime();
            lshdbscan.performClustering();
            endTime = System.nanoTime();
            System.out.println("Clustering took: " + ((endTime - startTime) / 1_000.0) + " microseconds");

            // dataset.enforceMinClusterSize();

            // Write benchmark results
            lshdbscan.writeBenchmarkResults("benchmark.txt", '\t');
            ...
            String outputFile = params.getFileName() + "_" +
                    ...
                    params.getNumberOfThreads() + ".idx_concurrentlshdbscan";
            ...
            String metadataFile = params.getFileName() + "_" +
                    params.getNumberOfHashTables() + "_" +
                    params.getNumberOfHyperplanesPerTable() + "_" +
                    params.getNumberOfThreads() + ".metadata";
            ...
            System.out.println("Running Param evaluation");
            ParameterResult result = evaluateClusteringResult(Globals.EPSILON, Globals.MIN_PTS, params.getNumberOfHashTables(), params.getNumberOfHyperplanesPerTable(), dataset);
